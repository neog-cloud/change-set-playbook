...
- Mantenha o fluxo dos artefatos: `planning.md` consolida descoberta e alinhamento; `specification.md` traduz o planejamento em escopo técnico; `review-cs-[ID].md` registra a auditoria independente. O planejamento não autoriza implementação por si só.
