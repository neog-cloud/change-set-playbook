...
Use [migrate-sprint-to-change-set.md](migrate-sprint-to-change-set.md) uma vez ao adaptar um projeto que ainda usa o modelo Sprint para o fluxo Change Set.
